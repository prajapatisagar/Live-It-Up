...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( esc_html__( 'This gallery contains <a %1$s>%2$s photos</a>.', 'live-it-up' ),
								'href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'live-it-up' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
								$total_images
							); ?></em></p>
				<?php endif; ?>
						<?php the_excerpt(); ?>
<?php endif; ?>
			...
			<div class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'live-it-up'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'live-it-up' ); ?>"><?php esc_html_e( 'More Galleries', 'live-it-up' ); ?></a>
			...
			<div class="entry-utility">
				<?php if ( count( get_the_category() ) ) : ?>
					<span class="cat-links">
						<?php printf( esc_html__( '<span class="%1$s">Posted in</span> %2$s', 'live-it-up' ), 'entry-utility-prep entry-utility-prep-cat-links', get_the_category_list( esc_html__( ', ', 'live-it-up' ) ) ); ?>
					</span>
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<?php
				...
				?>
					<span class="tag-links">
						<?php printf( esc_html__( '<span class="%1$s">Tagged</span> %2$s', 'live-it-up' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
					</span>
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<span class="comments-link"><?php comments_popup_link( esc_html__( 'Leave a comment', 'live-it-up' ), esc_html__( '1 Comment', 'live-it-up' ), esc_html__( '% Comments', 'live-it-up' ) ); ?></span>
