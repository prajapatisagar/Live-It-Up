...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p class="page-title"><a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php esc_attr( printf( esc_html__( 'Return to %s', 'live-it-up' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
						/* translators: %s - title of parent post */
						printf( esc_html__( '<span class="meta-nav">&larr;</span> %s', 'live-it-up' ), get_the_title( $post->post_parent ) );
					?></a></p>
				<?php endif; ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-meta">
						<?php
							printf( esc_html__('<span class="%1$s">By</span> %2$s', 'live-it-up'),
						...
						<?php
							printf( esc_html__('<span class="%1$s">Published</span> %2$s', 'live-it-up'),
							...
							if ( wp_attachment_is_image() ) {
								...
								printf( esc_html__( 'Full size is %s pixels', 'live-it-up'),
